-- QAIU Website Complete Database Schema for Supabase
-- This file contains all tables, indexes, triggers, and policies
...
CREATE POLICY "Public insert access to contact_messages" ON contact_messages
