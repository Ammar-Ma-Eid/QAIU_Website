...
// Helper function to revalidate all relevant paths
...
export async function addMember(data: any) {
    try {
        ...
        if (member) {
            const activitySuccess = await addActivity({
                action: 'created',
                entity: 'member',
            ...
            if (!activitySuccess) {
                console.warn('Failed to log activity for member creation');
            }
...
export async function updateMember(id: string, data: any) {
    try {
        ...
        if (member) {
            ...
            if (!activitySuccess) {
                console.warn('Failed to log activity for member update');
            }
...
export async function deleteMember(id: string) {
    try {
        ...
        if (success) {
            ...
            if (!activitySuccess) {
                console.warn('Failed to log activity for member deletion');
            }
...
export async function addEvent(data: any) {
    try {
        ...
        if (event) {
            ...
            if (!activitySuccess) {
                console.warn('Failed to log activity for event creation');
            }
...
export async function updateEvent(id: string, data: any) {
    try {
        ...
        if (event) {
            ...
            if (!activitySuccess) {
                console.warn('Failed to log activity for event update');
            }
...
export async function addBlogPost(data: any) {
    try {
        ...
        if (blogPost) {
            ...
            if (!activitySuccess) {
                console.warn('Failed to log activity for blog post creation');
            }
...
export async function addGlossaryTerm(data: any) {
    try {
        ...
        if (term) {
            ...
            if (!activitySuccess) {
                console.warn('Failed to log activity for glossary term creation');
            }
